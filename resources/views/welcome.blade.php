...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{('publicimages/ico/apple-touch-icon-144-precomposed.png')}}">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html"><img src="{{asset('public/images/home/logo.png')}}x" alt="" /></a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('publicimages/home/girl1.jpg')}}" class="girl img-responsive" alt="" />
